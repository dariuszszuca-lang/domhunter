      ...
      <section className="pt-10 lg:pt-16 pb-6">
        <Container size="wide">
          <div className="max-w-2xl">
            <p className="text-xs font-semibold uppercase tracking-wider text-brand-hover mb-3">
              Oferty
            </p>
    ...
    <section className="pb-20 lg:pb-28">
      <Container size="default">
        <div className="rounded-3xl bg-surface border border-border p-10 lg:p-14 text-center">
          <div className="inline-flex size-16 rounded-2xl bg-brand/15 text-brand-hover items-center justify-center mb-5 mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            >
              <Phone className="size-4 text-brand-hover" />
