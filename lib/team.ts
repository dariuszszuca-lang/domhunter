...
export const team: TeamMember[] = [
  ...
  },
  {
    ...
    bioParagraphs: [
      ...
      "Jestem również członkinią grupy SparkLady, dzięki czemu mam dostęp do unikalnych ofert nieruchomości, które często nie są dostępne w ogólnodostępnych serwisach i na otwartym rynku. Pozwala mi to jeszcze skuteczniej pomagać klientom w znalezieniu nieruchomości odpowiadającej ich potrzebom.",
