...
export const team: TeamMember[] = [
  ...
  },
  {
    ...
    specializations: ["Mieszkania", "Inwestycyjne", "Trójmiasto"],
    bio: "Agentka nieruchomości w biurze Dom Hunter, w branży od 2022 roku. Specjalizuje się w nieruchomościach mieszkaniowych, stawia na indywidualne podejście i relację z klientem.",
    bioParagraphs: [
      "Pochodzę z Ukrainy, w Polsce mieszkam od 2015 roku, a od 2022 roku z sukcesami rozwijam swoją karierę w branży nieruchomości.",
      "Nieruchomości to dla mnie nie tylko zawód, ale przede wszystkim pasja. Bardzo lubię pracę z ludźmi i cenię indywidualne podejście do każdego klienta. Wierzę, że każda osoba ma inne potrzeby, oczekiwania i cele, dlatego zawsze staram się najpierw dobrze poznać klienta, aby znaleźć rozwiązanie najlepiej dopasowane do jego sytuacji. To właśnie budowanie relacji i towarzyszenie klientom w podejmowaniu ważnych życiowych decyzji daje mi największą satysfakcję.",
      "Posiadam doświadczenie zarówno w sprzedaży nieruchomości mieszkaniowych, jak i obiektów inwestycyjnych, choć szczególnie bliskie są mi nieruchomości mieszkaniowe. Moje zaangażowanie i efektywność zostały docenione poprzez wyróżnienia wśród agentów nieruchomości. Nieustannie rozwijam swoje kompetencje i poszerzam wiedzę, aby zapewniać klientom obsługę na najwyższym poziomie.",
      "Jestem również członkinią społeczności Nieruchomości Spod Lady, dzięki czemu mam dostęp do unikalnych ofert nieruchomości, które często nie są dostępne w ogólnodostępnych serwisach i na otwartym rynku. Pozwala mi to jeszcze skuteczniej pomagać klientom w znalezieniu nieruchomości odpowiadającej ich potrzebom.",
      "Zapraszam do współpracy wszystkich, którzy szukają profesjonalnego wsparcia, bezpieczeństwa i indywidualnego podejścia na każdym etapie zakupu lub sprzedaży nieruchomości.",
    ],
    order: 6,
  },
  {
