        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8">
          {posts.map((post, i) => (
            ...
            >
              ...
              <div
                aria-hidden
                className="relative h-36 overflow-hidden bg-gradient-to-br from-brand to-brand-hover"
              >
                <span className="pointer-events-none absolute -bottom-6 right-4 select-none font-display text-[6.5rem] italic leading-none text-white/15">
